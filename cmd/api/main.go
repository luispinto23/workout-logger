...
import (
	...
	"my-workout-logs/internal/env"
	"my-workout-logs/internal/smtp"
	"my-workout-logs/internal/version"
...
func run(logger *slog.Logger) error {
	...
	cfg.cookie.secretKey = env.GetString("COOKIE_SECRET_KEY", "352uvkgwgjxxnljko4obkdqxxhx7a2p6")
	cfg.db.dsn = env.GetString("DB_DSN", dbDSN)
	cfg.db.automigrate = env.GetBool("DB_AUTOMIGRATE", true)
	cfg.jwt.secretKey = env.GetString("JWT_SECRET_KEY", "hbiatpuga7l7acwizwowm6gbulg4rmcu")
